...
SQUINT ist eine Progressive Web App (PWA), die Nutzern hilft, aus einer großen Anzahl ähnlicher Bilder die besten auszuwählen. Die App ist speziell für Fotografen und deren Kunden konzipiert, um den Auswahlprozess intuitiv, schnell und mobil zu gestalten.
...
- Öffentliche Websites, die Datenschutzbedenken auslösen können.
- Keine Möglichkeit, die Auswahl auf eine bestimmte Anzahl von Bildern zu begrenzen.
- Überladene Funktionen, die Konfiguration oder Erklärungen erfordern.
- Keine klare und intuitive Benutzerführung.

SQUINT adressiert diese Probleme durch:
- **Login-freien Zugriff** über geteilte Links.
- **Begrenzung der Auswahlmöglichkeiten** für klare Entscheidungen.
- **Minimalistisches Interface** mit Fokus auf Swipe-Gesten.
- **Vergleichsansicht** für direkte Gegenüberstellung von Bildern.
...
Der erste Entwurf orientierte sich an Apps wie Lightroom Mobile und umfasste:
- Ansichten für verschiedene Auswahlmöglichkeiten und Fotos.
...
### Erste Beobachtungen
- Nutzer hatten Schwierigkeiten, die Aufgabe abzuschließen, ein Foto auszuwählen und es an den Fotografen zu senden.
...
### Aktueller Stand
- **Interaktiver Prototyp** in Figma verfügbar: [SQUINT Figma-Prototyp](https://www.figma.com/proto/jAgd054xnXmdCasYTCVCAN/SQUINT?kind=&node-id=51179%3A5541&page-id=51179%3A5538&scaling=contain&starting-point-node-id=51179%3A5610&viewport=399%2C48%2C0.25)
- **Reduzierte Screens** für eine klare Nutzerführung.
- **Swipe-Mechanik** für intuitive Auswahl.

### Nächste Schritte
- **Technische Umsetzung** der PWA.
- **Weitere Usability-Tests** mit einer größeren Nutzergruppe.
- **Integration von Feedback** für kontinuierliche Verbesserung.